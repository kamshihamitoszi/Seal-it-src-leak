...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    const ImU32 outside_col[4] = { ImColor(187, 50, 255, 100)/*topright*/, ImColor(187, 50, 255, 100)/*botleft*/, ImColor(187, 50, 255, 100)/*botleft*/, ImColor(187, 50, 255, 100)/*botleft*/ };
    ...
    draw->AddRectFilledMultiColor(bb.Min, bb.Max, outside_col[1], outside_col[2], outside_col[3], outside_col[4], 100);
    draw->AddRectFilledMultiColor(bb.Min, bb.Max, inside_gradient_col[0], inside_gradient_col[1], inside_gradient_col[2], inside_gradient_col[3], 100);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags) {
    ...
    window->DrawList->AddRectFilled(frame_bb.Min, ImVec2(grab_bb.Min.x + 3, frame_bb.Max.y), ImColor(255, 30, 70), 5.0f);

    RenderText(total_bb.Min, label);

    PushStyleColor(ImGuiCol_Text, ImVec4(1.0f, 1.0f, 1.0f, it_anim->second.opacity)); {
        RenderTextClipped(total_bb.Min, total_bb.Max, value_buf, value_buf_end, NULL, ImVec2(0.5f, 0.5f));
    } PopStyleColor();
